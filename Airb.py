...
st.set_page_config(page_title="AirBnb-Analysis", page_icon=":mag:", layout="wide")
...
if SELECT == "Explore Data":
 ...
 if fl is not None:
   ...
   os.chdir(r"C:\users\LalithKishore 16\Desktop")
...
if SELECT == "Contact":
    ...
    col1, col2 = st.columns(2)
    col1.image(Image.open(r"C:\\Users\\LalithKishore 16\\Downloads\\airbnb.jpg"), width=500)
